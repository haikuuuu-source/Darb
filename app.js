...
function dateStr(d){
  // Local calendar date (not UTC) — toISOString() shifts the date across the
  // midnight boundary for any timezone ahead of UTC, which silently broke
  // streak counting for users east of Greenwich. Build the string from local
